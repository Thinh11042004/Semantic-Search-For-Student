      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="grid grid-cols-2 gap-x-12 gap-y-4 mb-6 md:mb-0">
            <Link to="/search-forms" className="text-blue-100 hover:text-white transition-colors">Search</Link>
            <Link to="/product" className="text-blue-100 hover:text-white transition-colors">Product</Link>
            ...
            <Link to="/help" className="text-blue-100 hover:text-white transition-colors">Help</Link>
